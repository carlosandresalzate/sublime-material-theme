...
class MtRepoCommand(sublime_plugin.WindowCommand):
    def run(self):
        ...
        webbrowser.open_new_tab('https://github.com/material-theme/sublime-material-theme')
...
class MtIssuesCommand(sublime_plugin.WindowCommand):
    def run(self):
        ...
        webbrowser.open_new_tab('https://github.com/material-theme/sublime-material-theme/issues')
